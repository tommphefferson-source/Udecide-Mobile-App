...
export const es: Record<string, string> = {
  ...
  // ── Voting records ────────────────────────────────────────────────
  "Voting Record": "Historial de votaciones",
  "All Votes": "Todas las votaciones",
  "Amendments": "Enmiendas",
  "Resolutions": "Resoluciones",
  "Nominations": "Nominaciones",
  "Procedural": "De procedimiento",
  "Other": "Otras",
  "Search votes...": "Buscar votaciones...",
  "Vote": "Voto",
  "Result": "Resultado",
  "Vote Details": "Detalles de la votación",
  "Official's Vote": "Voto del funcionario",
  "Vote Result": "Resultado de la votación",
  "Chamber Vote": "Votación de la cámara",
  "Vote Question": "Pregunta sometida a votación",
  "Chamber": "Cámara",
  "Session": "Sesión",
  ...
  "Abstain": "Abstención",
  "Source": "Fuente",
  "Data provided through LegiScan": "Datos proporcionados a través de LegiScan",
  "View Official Record": "Ver registro oficial",
  "Voting records are not currently available for this official.":
    "Los registros de votación no están disponibles por ahora para este funcionario.",
  "We couldn't confidently match this official to legislative records.":
    "No pudimos vincular con certeza a este funcionario con los registros legislativos.",
  "No votes match your filters.": "Ninguna votación coincide con tus filtros.",
  "Unable to load voting records": "No se pudieron cargar los registros de votación",
